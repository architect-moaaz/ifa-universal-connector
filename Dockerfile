...
ENV  BOOTSTRAP_SERVERS=151.106.38.94:9092
ENV  GROUP_ID=1
...
RUN echo $USER
# Copy jar files
COPY ./src/main/resources/jars/mysql-connector-java-8.0.30.jar ./kafka/libs/mysql-connector-java-8.0.30.jar
COPY ./src/main/resources/jars/mongodb-kafka-connect-mongodb-1.8.1 /kafka/connect/mongodb-kafka-connect-mongodb-1.8.1 
#COPY ./src/main/resources/jars/init-kafka-connect-odp-1.3.3/ /kafka/connect/
